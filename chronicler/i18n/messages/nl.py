...
MESSAGES = {
    ...
    "forms": {
        "regex_hint": "bijv. ^([A-Z]+):\\s+(.*)$",
        "chronicle_title": "Titel van de Chronicle",
        "create_title": "Nieuwe Chronicle maken",
        "create": "Maken",
        "title": "Titel",
        "description": "Beschrijving",
        "kind": "Soort",
        "kind_hint": "bijv. Podcast, D&D-sessie, Vergadering",
        "duration": "Duur",
        "duration_hint": "bijv. 1u 24m",
        "edit_title": "Chronicle bewerken",
        "regex": "Regelpatroon",
        "speaker_group": "Groepsindex spreker",
        "text_group": "Groepsindex tekst",
        "timestamp_group": "Groepsindex tijdcode (optioneel)",
        "timestamp_group_hint": "Laat leeg als het bestand geen tijdcodes heeft",
        "select_and_import": "Bestand kiezen en importeren",
    },
    "archive": {
        "subtitle": "Je zelfstandige gespreksprojecten.",
        "import_into": "Importeren in deze Chronicle",
        "no_description": "Geen beschrijving",
        "link": "Externe Chronicle koppelen",
        "load_failed": "Fout bij laden van Chronicles: {error}",
        "title": "Archief",
        "empty": "Nog geen Chronicles.",
        "search": "Zoek in Chronicles",
        "new": "Nieuwe Chronicle",
        "import": "Importeren",
    ...
    "tasks": {
        "heading": "Taken verwerken",
        "subtitle": "Scribes werken door, ook als je Chronicler sluit.",
        "search": "Taken zoeken",
        "hide_completed": "Voltooide taken verbergen",
        "retry_tooltip": "Deze taak opnieuw uitvoeren",
    ...
    "transcript": {
        ...
        "save_failed": "Kan de wijziging niet opslaan: {error}",
        "title": "Transcript",
    ...
    "actions": {
        ...
        "edit": "Chronicle bewerken",
        "updated": "Chronicle bijgewerkt",
        "gone": "Deze Chronicle bestaat niet meer.",
        "delete": "Chronicle verwijderen",
        "delete_title": "Chronicle verwijderen?",
        "delete_message": (
        ...
        "transcript_exists_message": (
            "Deze Chronicle heeft al een geimporteerd transcript. Overschrijven met het "
    ...
    "sources": {
        ...
        "normalize_unavailable": "Volumenormalisatie is hier niet beschikbaar",
        "transcribe_unavailable": "Transcriptie is hier niet beschikbaar",
        "record_unavailable": "Opnemen is niet beschikbaar in deze build",
    ...
    "recording": {
        ...
        "start": "Starten",
        "stop": "Stoppen",
        "save": "Opslaan in Chronicle",
        "saved": "'{name}' toegevoegd aan deze Chronicle",
    ...
    "summaries": {
        ...
        "open_folder": "Open de Chronicles map",
