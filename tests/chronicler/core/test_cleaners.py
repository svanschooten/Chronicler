...
def test_cleaner_merges_consecutive_lines():
    ...
    lines = [
        TranscriptLine(speaker_id=speaker_id, speaker_name="GM", text="nice", start_time=0.0, end_time=1.0),
        TranscriptLine(speaker_id=speaker_id, speaker_name="GM", text="okay", start_time=1.0, end_time=2.0),
        TranscriptLine(speaker_id=speaker_id, speaker_name="GM", text="I am the sound", start_time=2.0, end_time=3.0),
    ]
...
def test_cleaner_handles_different_speakers():
    ...
    s2 = uuid.uuid4()
    lines = [
        TranscriptLine(speaker_id=s1, speaker_name="S1", text="Hello", start_time=0.0, end_time=1.0),
        TranscriptLine(speaker_id=s1, speaker_name="S1", text="world", start_time=1.0, end_time=2.0),
...
def test_cleaner_normalizes_whitespace():
    ...
    s1 = uuid.uuid4()
    lines = [
        TranscriptLine(speaker_id=s1, speaker_name="S1", text="  Hello   world  ", start_time=0.0, end_time=1.0),
    ]
    cleaned = cleaner.clean(lines)
    assert cleaned[0].text == "Hello world"
