...
```text
Chronicler 1.0.2 thin-client check
...
Connecting thin client...
  ok    server version 1.0.2 matches client 1.0.2
...
```text
Connected to Chronicler server (version 1.0.2, chronicles: 3, capabilities: clean, export, import, transcribe)
```
