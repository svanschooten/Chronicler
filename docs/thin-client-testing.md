...
```text
Chronicler 1.0.3 thin-client check
...
Connecting thin client...
  ok    server version 1.0.3 matches client 1.0.3
...
```text
Connected to Chronicler server (version 1.0.3, chronicles: 3, capabilities: clean, export, import, transcribe)
```
