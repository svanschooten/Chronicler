...
```text
Chronicler 1.0.4 thin-client check
...
Connecting thin client...
  ok    server version 1.0.4 matches client 1.0.4
...
```text
Connected to Chronicler server (version 1.0.4, chronicles: 3, capabilities: clean, export, import, transcribe)
```
