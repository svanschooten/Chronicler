...
```text
Chronicler 0.1.0a0 thin-client check
...
Connecting thin client...
  ok    server version 0.1.0a0 matches client 0.1.0a0
...
```text
Connected to Chronicler server (version 0.1.0a0, chronicles: 3, capabilities: clean, export, import, transcribe)
```
